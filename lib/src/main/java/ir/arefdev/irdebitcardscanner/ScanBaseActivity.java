...
//            dialog.show();
    ...
    public void onClick(View view) {
        if (mCamera != null && mFlashlightId == view.getId()) {
            ImageView flashlight = findViewById(mFlashlightId);
            ...
            if (Camera.Parameters.FLASH_MODE_TORCH.equals(flashMode)) {
                ...
                flashlight.setImageResource(R.drawable.icon_flash_off);
                flashlight.setBackgroundResource(R.drawable.background_flash_off);
            } else {
                parameters.setFlashMode(Camera.Parameters.FLASH_MODE_TORCH);
                flashlight.setImageResource(R.drawable.icon_flash_on);
                flashlight.setBackgroundResource(R.drawable.background_flash_on);
            }
